...
- **`onChangeTab`** _(Function)_ - function to call when tab changes, should accept 1 argument which is an Object containing two keys: `i`: the index of the tab that is selected, `component`: the component of the tab that is selected (note: renamed from `ref` for React 19 compatibility)
